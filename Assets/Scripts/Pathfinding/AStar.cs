...
public class AStar : MonoBehaviour
{
    ...
    private static HashSet<Vector3Int> noDiaonal1Tiles = new HashSet<Vector3Int>();
    ...
    public static HashSet<Vector3Int> NoDiaonal1Tiles
    {
        get
        {
            return noDiaonal1Tiles;
        }
    }
    ...
    private void ExamineNeighbours(List<Node> neighbours, Node current)
    {
        for (int i = 0; i < neighbours.Count; i++)
        {
            ...
            if (gScore == 14&& NoDiaonal1Tiles.Contains(neighbour.Position)&&noDiaonal1Tiles.Contains(current.Position))
            {
                continue;
            }
